<template>
  <div id="AuditIT">
    ...
    <div>
      ...
      <div class="pt-[98px] pb-[112px] flex justify-center site_color_1">
        <div class="w-[835px]">
        <h3 class="text-h3 ml-[15px] mb-[50px]">Мы готовы оказать поддержку существующему IT отделу по ряду пунктов:</h3>
