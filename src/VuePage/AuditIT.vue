    ...
    <div>
      <div class="py-[30px] flex flex-wrap gap-x-[76px] justify-center">
        <div class="mt-[30px] site_color_1 flex flex-col gap-[26px]">
          <h1>Один админ - <br>хорошо... <br>А целая команда <br>готова ему <br>помочь!</h1>
      ...
      <div class="pt-[98px] pb-[112px] flex justify-center site_color_1">
        <div class="w-[835px]">
        <h3 class="ml-[15px] mb-[50px]">Мы готовы оказать поддержку существующему IT отделу по ряду пунктов:</h3>
